          ...
          <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <ul>
                    ...
                    <li><i class="icofont-rounded-right"></i>
                      <strong>PhEmailone:</strong> email@example.com</li>
                    <li><i class="icofont-rounded-right"></i>
              ...
              <p>
                ...
                officiis optio vero. Quisquam sunt adipisci omnis
                et ut. Nulla accusantium dolor incidunt officia
                tempore. Et eius omnis.
                Cupiditate ut dicta maxime officiis quidem quia.
                Sed et consectetur qui quia repellendus itaque
                neque. Aliquid amet quidem ut quaerat cupiditate.
        ...
        <div class="container">
          ...
          <div class="section-title">
            ...
            <p>
              ...
              Et nemo qui impedit suscipit alias ea. Quia fugiat sit in
          ...
          <div class="row">
            <div class="col-lg-6" data-aos="fade-up">
              ...
              <div class="resume-item pb-0">
                <h4>Alex Smith</h4>
                <p>
                  <em>Innovative and deadline-driven Graphic Designer
                    with 3+ years of experience designing and developing
                    user-centered digital/print marketing material
              ...
              <div class="resume-item">
                ...
                <p>
                  Qui deserunt veniam. Et sed aliquam labore tempore
                  sed quisquam iusto autem sit. Ea vero voluptatum
              ...
              <div class="resume-item">
                ...
                <h5>2010 - 2014</h5>
                <p><em>Rochester Institute of Technology, Rochester, NY</em></p>
                <p>Quia nobis sequi est occaecati aut. Repudiandae
                  et iusto quae reiciendis et quis Eius vel ratione
                  eius unde vitae rerum voluptates asperiores voluptatem
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="resume-item">
                ...
                <ul>
                  ...
                  <li>Delegate tasks to the 7 members of the design
                    team and provide counsel on all aspects of the project. </li>
                  <li>Supervise the assessment of all graphic materials
                    in order to ensure quality and accuracy of the design</li>
                  <li>Oversee the efficient use of production project
                    budgets ranging from $2,000 - $25,000</li>
                </ul>
              </div>
              <div class="resume-item">
                ...
                <ul>
                  ...
                  <li>Recommended and consulted with clients on the
                    most appropriate graphic design</li>
                  <li>Created 4+ design presentations and proposals a
                    month for clients and account managers</li>
                </ul>
              </div>
            </div>
          </div>
...
<script>
// import './html/iPortfolio/assets/vendor/bootstrap/css/bootstrap.min.css';
// import $ from 'jquery';
// @ is an alias to /src
export default {
  data() {
...
<style
    src="./html/iPortfolio/assets/vendor/bootstrap/css/bootstrap.min.css"
    scoped land="scss"
></style>

<style
    src="./html/iPortfolio/assets/vendor/icofont/icofont.min.css"
    scoped land="scss"
></style>

<style
    src="./html/iPortfolio/assets/vendor/boxicons/css/boxicons.min.css"
    scoped land="scss"
></style>

<style
    src="./html/iPortfolio/assets/vendor/venobox/venobox.css"
    scoped land="scss"
></style>

<style
    src="./html/iPortfolio/assets/vendor/owl.carousel/assets/owl.carousel.min.css"
    scoped land="scss"
></style>

<!--<style-->
<!--    src="./html/iPortfolio/assets/vendor/aos/aos.css"-->
<!--    scoped land="scss"-->
<!--&gt;</style>-->
...
<style scoped>
  ...
  .testimonials .testimonial-item
  .quote-icon-left, .testimonials .testimonial-item .quote-icon-right {
    color: #c3e8fa;
    font-size: 26px;
  }
  ...
  .portfolio-details .portfolio-details-carousel
  .owl-nav, .portfolio-details .portfolio-details-carousel .owl-dots {
    margin-top: 5px;
    text-align: left;
  }
